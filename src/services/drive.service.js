...
export const createDrive = async (driveData) => {
  try {
    const response = await axios.post("/api/drives/create-drive", driveData);
    return {
...
//  try {
//    const response = await axios.get("/api/drives/fetch-all-drives");
//    return {
//      status: response.data.status,
//      message: response.data.message,
//      data: response.data.data,
...
//  try {
//    const response = await axios.get(`/api/drives/fetch-one-drive/${id}`);
//    return {
//      status: response.data.status,
//      message: response.data.message,
//      data: response.data.data,
...
//  try {
//    const response = await axios.put(`/api/drives/update-drive/${id}`, driveData);
//    return {
//      status: response.data.status,
//      message: response.data.message,
//      data: response.data.data,
...
//  try {
//    const response = await axios.delete(`/api/drives/delete-drive/${id}`);
//    return {
//      status: response.data.status,
//      message: response.data.message,
//      data: response.data.data,
